<div class="container">
    <form id="addEmployeeForm" action="{{ route('dashboard.employees.store') }}" method="POST" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    <label>CNIC</label>
                    <input type="text" id="cnic" class="form-control" name="cnic" placeholder="CNIC" required="">
