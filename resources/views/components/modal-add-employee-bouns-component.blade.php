...
<div id="add_employee_bouns" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create Employee Bouns</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="addEmployeeBouns" method="POST"
                   action="{{ route('dashboard.employee-bouns.store') }}" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">  
                            <div class="form-group">
                                ...
                                <input id="name" class="block mt-4 w-full form-control" type="text" name="bouns_name" required
                    ...
                    <div class="submit-section">
                        <button class="btn btn-primary submit-btn">Add Employee Bouns</button>
                    </div>
                </form>
            </div>
        </div>
