<div class="container">
    <form id="addEmployeeForm" action="{{ route('dashboard.employees.update', [$employee->id]) }}" method="POST"
        novalidate>
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="test" class="form-control" placeholder="Father Name" name="father_name"
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <span class="form-text text-muted">e.g "xxxxx-xxxxxxx-x"</span>
                </div>
            </div>
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control" placeholder="Primary Contact" name="primary_contact"
                    value="{{ $employee->primary_contact }}" required="">
            </div>
            <div class="col-md-4 mb-3">
                <label for="">Secondary Contact</label>
                <input type="number" class="form-control" placeholder="Secondary Contact"
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="form-control js-example-basic-single" name="designation_id" id="department" required>
                    <option value="{{ $employee->designation_id }}" selected> {{ $employee->designation->name }}
                    </option>
